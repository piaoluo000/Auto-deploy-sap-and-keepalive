...
# 环境变量配置
EMAIL="zyqhk@tiffincrane.com"   # 登录邮箱
PASSWORD="Bjl8831484"     # 登录密码

# 要保活的URL列表,多个用英文空格分隔
URLS="https://free-sgtifonb.cfapps.ap21.hana.ondemand.com https://free-uskriebg.cfapps.us10-001.hana.ondemand.com"  
